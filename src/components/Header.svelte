<section
  class="pt-20 pb-10 px-4 text-center flex flex-col items-center w-full max-w-[800px] mx-auto"
  id="header"
>
  ...
  <div class="w-full">
    ...
    <div class="px-10 w-full mx-auto font-light">
      ...
      <p class="text-left mb-3">
        ...
        development, and the intersection of technology and medicine. Outside of
        school, I love weightlifting and playing the piano. Let's collaborate
